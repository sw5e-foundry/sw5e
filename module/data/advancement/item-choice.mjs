 ...
 * @property {PowerConfigurationData} power                   Mutations applied to power items.
 ...
 * @property {"available"|number} restriction.level           Level of power allowed.
 */
 ...
 *
 * @property {string} ability                                  Ability selected for the powers.
