...
export default class ItemSheet5e extends ItemSheet {
  ...
  constructor(...args) {
    ...
    } else if ( this.object.data.type === "archetype" ) {
  ...
  async getData(options) {
    ...
    data.config.powerComponents = {...data.config.powerComponents, ...data.config.powerTags};
  ...
  _getSubmitData(updateData={}) {
    ...
    if ( data.data?.uses?.max ) {
      ...
      if ( !maxRoll.isDeterministic ) {
        ...
        return ui.notifications.error(game.i18n.format("SW5E.FormulaCannotContainDiceError", {
  ...
  _onConfigureTraits(event) {
    ...
    switch (a.dataset.options) {
      ...
      case "skills":
        ...
        options.choices =
          Object.fromEntries(Object.entries(CONFIG.SW5E.skills).filter(([skill]) => choiceSet.includes(skill)));
