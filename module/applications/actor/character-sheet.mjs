...
export default class ActorSheet5eCharacter extends ActorSheet5e {
  ...
  _prepareItems(context) {
    ...
    let {items, powers, feats, species, backgrounds, classes, archetypes} = context.items.reduce((obj, item) => {
      ...
      return obj;
    }, { items: [], powers: [], feats: [], species: [], backgrounds: [], classes: [], archetypes: [] });
    ...
    const features = {
      species: {
        label: CONFIG.Item.typeLabels.species, items: species,
        hasActions: false, dataset: {type: "species"} },
      background: {
