...
export default class ItemGrantAdvancement extends Advancement {
   ...
   * @type {Set<string>}
   */
  static VALID_TYPES = new Set(["feat", "power", "consumable", "container", "equipment", "loot", "tool", "weapon"]);
  ...
  summaryForLevel(level, { configMode=false }={}) {
    ...
    if ( !this.value.added || configMode ) {
      return this.configuration.items.reduce((html, i) => html + sw5e.utils.linkForUuid(i.uuid), "");
    }
