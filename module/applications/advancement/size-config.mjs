...
export default class SizeConfig extends AdvancementConfig {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["sw5e", "advancement", "size"],
      template: "systems/sw5e/templates/advancement/size-config.hbs"
    });
  }
  ...
  getData() {
    return foundry.utils.mergeObject(super.getData(), {
      ...
      sizes: Object.entries(CONFIG.SW5E.actorSizes).reduce((obj, [key, { label }]) => {
