  ...
  static defineSchema() {
    return {
      ability: new foundry.data.fields.StringField({
        required: true, nullable: true, initial: null, label: "SW5E.AbilityModifier"
      }),
      actionType: new foundry.data.fields.StringField({
        required: true, nullable: true, initial: null, label: "SW5E.ItemActionType"
      }),
      ...
      save: new foundry.data.fields.SchemaField({
        ...
        dc: new foundry.data.fields.NumberField({
          required: true, min: 0, integer: true, label: "SW5E.AbbreviationDC"
        }),
        scaling: new foundry.data.fields.StringField({
          required: true, blank: false, initial: "power", label: "SW5E.ScalingFormula"
        })
