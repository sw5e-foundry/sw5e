 ...
 * @abstract
 */
export default class ActorSheetDnD5e extends ActorSheetMixin(ActorSheet) {
  ...
  /** @override */
  get template() {
    if (!game.user.isGM && this.actor.limited) return "systems/sw5e/templates/actors/DnD5eActor/limited-sheet.hbs";
    return `systems/sw5e/templates/actors/DnD5eActor/${this.actor.type}-sheet.hbs`;
  }
  ...
  _onDropPower(itemData) {
    ...
    const isForcePower = item.system.school in CONFIG.SW5E.powerSchoolsForce;
    const isTechPower = item.system.school in CONFIG.SW5E.powerSchoolsTech;
