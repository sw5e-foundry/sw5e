...
export default class ActorSheet5eCharacter2 extends ActorSheet5eCharacter {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      dragDrop: [
        ...
        { dragSelector: ":is(.species, .background)[data-item-id]", dropSelector: null },
  ...
  async _renderOuter() {
    ...
    // setTheme(html[0], this.actor.getFlag("sw5e", "theme"));
  ...
  async getData(options) {
    ...
    // Size
    context.size = {
      label: CONFIG.SW5E.actorSizes[traits.size]?.label ?? traits.size,
  ...
  _onFindItem(type) {
    switch ( type ) {
      ...
      case "species": game.packs.get(CONFIG.SW5E.sourcePacks.RACES)?.render(true); break;
