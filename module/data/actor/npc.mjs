    ...
    return this.mergeSchema(super.defineSchema(), {
      ...
      details: new foundry.data.fields.SchemaField({
        ...
        type: new foundry.data.fields.SchemaField({
          ...
          subtype: new foundry.data.fields.StringField({required: true, label: "SW5E.CreatureTypeSelectorSubtype"}),
          swarm: new foundry.data.fields.StringField({required: true, blank: true, label: "SW5E.CreatureSwarmSize"}),
