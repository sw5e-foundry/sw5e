  ...
  #buildCSS() {
    if ( !this.constructor._stylesheet ) {
      ...
      this.constructor._stylesheet.replaceSync(`
        ...
        div { --_fill: var(--proficiency-cycle-enabled-color, var(--sw5e-color-blue)); }
        div:has(:disabled, :focus-visible) { --_fill: var(--proficiency-cycle-disabled-color, var(--sw5e-color-gold)); }
