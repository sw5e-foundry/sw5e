 ...
 * @extends {Dialog}
 */
export default class CheckboxSelect extends Dialog {
    ...
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            template: "systems/sw5e/templates/apps/checkbox-select.html",
            classes: ["sw5e", "dialog"]
        });
    }
     ...
     * });
     */
    static async checkboxSelect({title, content, checkboxes, defaultSelect=[], disabled=[], confirmLabel="Confirm", render, rejectClose=false, options={}}={}) {
