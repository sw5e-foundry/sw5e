...
window.customElements.define("sw5e-effects", EffectsElement);
window.customElements.define("sw5e-icon", IconElement);
window.customElements.define("sw5e-inventory", InventoryElement);
