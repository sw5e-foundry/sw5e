...
export default class TraitAdvancement extends Advancement {
  ...
  static get metadata() {
    return foundry.utils.mergeObject( super.metadata, {
      ...
      order: 30,
      icon: "systems/sw5e/icons/svg/trait.svg",
      title: game.i18n.localize( "SW5E.AdvancementTraitTitle" ),
      hint: game.i18n.localize( "SW5E.AdvancementTraitHint" ),
      apps: {
        config: TraitConfig,
        flow: TraitFlow
      }
  ...
  sortingValueForLevel( levels ) {
    const traitOrder = Object.keys( CONFIG.SW5E.traits ).findIndex( k => k === this.representedTraits().first() );
    const modeOrder = Object.keys( CONFIG.SW5E.traitModes ).findIndex( k => k === this.configuration.mode );
  ...
  async actorSelected() {
    ...
    const traitTypes = this.configuration.mode === "default" ? Object.keys( CONFIG.SW5E.traits )
      : filteredKeys( CONFIG.SW5E.traits, t => t.expertise );
  ...
  async availableChoices( chosen ) {
    ...
    if ( this.configuration.allowReplacements && ( unfilteredLength > available.length ) ) {
      ...
      return {
        ...
        label: game.i18n.format( "SW5E.AdvancementTraitChoicesRemaining", {
