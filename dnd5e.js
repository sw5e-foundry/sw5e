...
Hooks.once("setup", function() {
  const localizeKeys = [
    ...
    "skills", "powerComponents", "powerLevels", "powerPreparationModes", "powerScalingModes", "powerSchools",
  ...
  const sortKeys = [
    ...
    "languages", "miscEquipmentTypes", "movementTypes", "polymorphSettings", "senses", "skills", "powerScalingModes",
    "powerSchools", "targetTypes", "toolProficiencies", "toolTypes", "vehicleTypes", "weaponProperties"
  ];
