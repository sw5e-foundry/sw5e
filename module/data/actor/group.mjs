...
/**
 * A data model and API layer which handles the schema and functionality of "group" type Actors in the sw5e system.
 ...
 * const g = new sw5e.documents.Actor5e({
 *  type: "group",
 *  name: "Test Group",
 *  system: {
...
export default class GroupActor extends ActorDataModel.mixin(CurrencyTemplate) {
  ...
  static defineSchema() {
    return this.mergeSchema(super.defineSchema(), {
      ...
      description: new SchemaField({
        ...
        summary: new HTMLField({label: "SW5E.DescriptionSummary"})
      }),
      ...
      attributes: new SchemaField({
        movement: new SchemaField({
          land: new NumberField({nullable: false, min: 0, step: 0.1, initial: 0, label: "SW5E.MovementLand"}),
          water: new NumberField({nullable: false, min: 0, step: 0.1, initial: 0, label: "SW5E.MovementWater"}),
          air: new NumberField({nullable: false, min: 0, step: 0.1, initial: 0, label: "SW5E.MovementAir"})
        })
  ...
  async rest(config, result) {
     ...
     * @function sw5e.groupRestCompleted
     * @memberof hookEvents
     ...
     */
    Hooks.callAll("sw5e.groupRestCompleted", this.parent, results);
