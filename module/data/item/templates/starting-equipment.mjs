...
export class EquipmentEntryData extends foundry.abstract.DataModel {
  ...
  static GROUPING_TYPES = {
    OR: "SW5E.StartingEquipment.Operator.OR",
    AND: "SW5E.StartingEquipment.Operator.AND"
  };
  ...
  static OPTION_TYPES = {
    // Category types
    armor: "SW5E.StartingEquipment.Choice.Armor",
    tool: "SW5E.StartingEquipment.Choice.Tool",
    weapon: "SW5E.StartingEquipment.Choice.Weapon",
    focus: "SW5E.StartingEquipment.Choice.Focus",

    // Generic item type
    linked: "SW5E.StartingEquipment.SpecificItem"
  };
  ...
  /**
   * Where in `CONFIG.SW5E` to find the type category labels.
