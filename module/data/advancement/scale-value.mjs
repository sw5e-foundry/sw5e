  ...
  static defineSchema() {
    return {
      ...
      type: new foundry.data.fields.StringField({
        required: true, initial: "string", choices: TYPES, label: "SW5E.AdvancementScaleValueTypeLabel"
      }),
...
export class ScaleValueType extends foundry.abstract.DataModel {
  ...
  static get metadata() {
    return {
      label: "SW5E.AdvancementScaleValueTypeString",
      hint: "SW5E.AdvancementScaleValueTypeHintString",
      isNumeric: false
    };
  }
...
export class ScaleValueTypeDistance extends ScaleValueTypeNumber {
  ...
  /** @inheritdoc */
  get display() {
    return `${this.value} ${CONFIG.SW5E.movementUnits[this.parent.configuration.distance?.units ?? "ft"]}`;
  }
}
